        ...
        <Route path='/chat-section' exact>
          ...
          {isOpened && (
            <ChatSection
              ...
              baseHubUrl='https://localhost:44320'
              userId={968}
              token='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..PO_ZTVaaMvviJQ45UAZJ05PRYtaHbJtfvrS8ATFJgqY'
